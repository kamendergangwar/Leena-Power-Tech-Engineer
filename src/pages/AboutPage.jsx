...
const AboutPage = () => {
  return (
    <div className="bg-[#e5e5e5]">
      <section className="relative h-[260px] overflow-hidden sm:h-[320px] md:h-[640px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-3xl font-semibold text-white sm:text-5xl md:text-7xl">About Us</h1>
            <div className="mx-auto mt-4 h-1 w-24 bg-leena-yellow md:mt-6" />
          </div>
        </div>
      </section>

      <section className="mx-auto max-w-[1260px] px-4 py-12 sm:py-16 md:px-8 md:py-24">
        <div className="grid items-center gap-8 lg:grid-cols-[1.02fr_0.98fr]">
          ...
          <article className="border border-[#d4d4d4] bg-[#f2f2f2] p-6 shadow-[0_7px_14px_rgba(0,0,0,0.16)] sm:p-8 md:p-10 lg:-ml-24">
            <h2 className="text-3xl font-semibold text-[#162d7a] sm:text-4xl">About Us</h2>
            <div className="mt-3 h-1 w-24 bg-leena-yellow" />
            <p className="mt-6 text-base leading-7 text-[#343434] sm:text-[18px] sm:leading-8 md:leading-9">
      ...
      <section className="bg-[#dfdfdf] py-12 sm:py-16 md:py-24">
        <div className="mx-auto grid max-w-[1260px] gap-10 px-4 md:px-8 lg:grid-cols-[1.03fr_0.97fr]">
          <div>
            <h2 className="text-3xl font-semibold text-[#162d7a] sm:text-4xl">Our contribution in nation building</h2>
            <div className="mt-3 h-1 w-24 bg-leena-yellow" />
            <p className="mt-6 text-base leading-7 text-[#1f2735] sm:text-[18px] sm:leading-8 md:leading-9">
            ...
            <a
              href={financeDoc}
              download
              className="mt-8 inline-block w-full rounded bg-[#172977] px-6 py-3 text-center text-base font-medium text-white transition hover:bg-[#0e1d5e] sm:w-auto sm:px-8 sm:text-lg"
            >
      ...
      <section className="py-14 sm:py-20 md:py-28">
        <div className="mx-auto grid max-w-[1260px] gap-12 px-4 md:px-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="text-center">
            <h2 className="text-4xl font-semibold text-[#162d7a] sm:text-5xl">Vision & Mission</h2>
            <div className="mx-auto mt-6 h-1 w-24 bg-leena-yellow" />
            <img src={aboutVision} alt="Vision illustration" className="mx-auto mt-10 w-full max-w-[430px] sm:mt-14" />
          </div>
          <article className="rounded-[26px] border border-[#d3d3d3] bg-[#f3f3f3] p-6 shadow-[0_3px_12px_rgba(0,0,0,0.14)] sm:p-8 md:p-10">
            <div className="flex items-start gap-4">
              <span className="mt-1 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-[#172977] text-xl text-white sm:h-14 sm:w-14 sm:text-2xl">
                &#9679;
              </span>
              <div>
                <h3 className="text-3xl font-semibold text-[#162d7a] sm:text-4xl">Vision</h3>
                <p className="mt-3 text-base leading-7 text-[#1f2735] sm:text-[18px] sm:leading-8 md:leading-9">
            ...
            <div className="mt-10 flex items-start gap-4">
              ...
              <div>
                <h3 className="text-3xl font-semibold text-[#162d7a] sm:text-4xl">Mission</h3>
                <ul className="mt-3 list-disc space-y-2 pl-6 text-base leading-7 text-[#1f2735] sm:text-[18px] sm:leading-8 md:leading-9">
      ...
      <section className="pb-12 md:pb-16">
        <div className="mx-auto max-w-[1260px] px-4 md:px-8">
          <h2 className="text-4xl font-semibold text-[#162d7a] sm:text-5xl">Company Values:</h2>
          <ul className="mt-8 space-y-4 text-base leading-7 text-[#1f2735] sm:text-[18px] sm:leading-8 md:leading-9">
            {values.map((item) => (
      ...
      <section className="bg-white pt-12 sm:pt-14">
        <div className="mx-auto max-w-[1260px] px-4 pb-10 text-center md:px-8">
          <h2 className="text-4xl font-semibold text-[#162d7a] sm:text-5xl md:text-6xl">Regional Presence</h2>
          <div className="mx-auto mt-6 h-1 w-24 bg-leena-yellow" />
          <p className="mt-8 text-lg text-[#2e2e2e] sm:text-xl md:text-[22px]">Maharashtra, Kerala, Bihar, Jharkhand, Goa, Uttar Pradesh, Assam</p>
        </div>
