...
export const pageContent = {
  ...
  [ROUTES.currentVacancy]: {
    title: 'Join us',
    subtitle: 'Current openings across LPTE teams.',
    intro: 'Browse active openings across LPTE teams and filter by category, type, or location.',
    sections: [
      {
        heading: 'Jobs',
      },
...
export const pageImages = {
  ...
  [ROUTES.currentVacancy]: {
    hero: asset('assets/pages/current-vacancy/current-vacancy-hero-live.png'),
  },
  [ROUTES.joinTeam]: {
    hero: asset('assets/pages/join-team/join-team-hero-live.png'),
  },
  [ROUTES.hrInitiatives]: {
    hero: asset('assets/pages/hr/hr-hero-live.png'),
    gallery: [{ src: asset('assets/pages/hr/hr-initiatives-photo-live.png'), alt: 'LPTE human resource initiatives' }],
  },
  [ROUTES.events]: {
